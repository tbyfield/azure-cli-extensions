...
class DevBox(msrest.serialization.Model):
    ...
    :param catalog_name: Name of the catalog used to configure this Dev Box.
    :type catalog_name: str
    :param dev_box_configuration_name: Name of the DevBox Configuration used to configure this Dev
     Box.
    :type dev_box_configuration_name: str
    """
    ...
    _validation = {
        ...
        'created_time': {'readonly': True},
        'catalog_name': {'max_length': 63, 'min_length': 3, 'pattern': r'^[a-zA-Z0-9][a-zA-Z0-9-_.]{2,62}$'},
        'dev_box_configuration_name': {'max_length': 63, 'min_length': 3, 'pattern': r'^[a-zA-Z0-9][a-zA-Z0-9-_.]{2,62}$'},
    }
    ...
    _attribute_map = {
        ...
        'dev_box_configuration_name': {'key': 'devBoxConfigurationName', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        *,
        ...
        dev_box_configuration_name: Optional[str] = None,
        **kwargs
    ):
        ...
        self.dev_box_configuration_name = dev_box_configuration_name
