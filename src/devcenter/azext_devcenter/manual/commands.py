...
def load_command_table(self, _):
    ...
    devcenter_environment_definitions_dp = CliCommandType(
        operations_tmpl=(
            "azext_devcenter.vendored_sdks.devcenter_dataplane.operations._environment_definitions_operations#EnvironmentDefinitionsOperations.{}"
        ),
        client_factory=cf_environment_definitions_dp,
    )
    ...
    with self.command_group("devcenter dev catalog", devcenter_catalog_dp) as g:
        g.custom_command(
            "list",
            "devcenter_catalog_list_dp",
        )
        g.custom_show_command("show", "devcenter_catalog_show_dp")

    with self.command_group(
        "devcenter dev environment-definition", devcenter_environment_definitions_dp
    ) as g:
        g.custom_command(
            "list",
            "devcenter_environment_definition_list_dp",
        )
