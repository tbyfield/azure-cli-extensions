...
def devcenter_project_show_dp(cmd, project_name, dev_center=None, endpoint=None):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
...
def devcenter_pool_show_dp(cmd, project_name, pool_name, dev_center=None, endpoint=None):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
    return cf_dataplane.pool.get(pool_name=pool_name)


def devcenter_schedule_list_dp(cmd, project_name, pool_name, dev_center=None, endpoint=None):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
    return cf_dataplane.schedule.list(pool_name=pool_name)


def devcenter_schedule_show_dp(cmd, project_name, pool_name, schedule_name, dev_center=None, endpoint=None):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
...
def devcenter_dev_box_show(cmd, project_name, dev_box_name, user_id="me", dev_center=None, endpoint=None):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
...
def devcenter_dev_box_create(
    ...
    local_administrator=None,
    catalog_name=None,
    dev_box_configuration_name=None,
    dev_center=None, endpoint=None
):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
    body = {}
    ...
    if dev_box_configuration_name is not None:
        body["dev_box_configuration_name"] = dev_box_configuration_name
    return sdk_no_wait(
        no_wait,
...
def devcenter_dev_box_delete(
    cmd, project_name, dev_box_name, user_id="me", no_wait=False, dev_center=None, endpoint=None
):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
    return sdk_no_wait(
        no_wait,
...
def devcenter_dev_box_delay_all_actions(
    ...
    return cf_dataplane.dev_box.delay_actions(
        user_id=user_id, dev_box_name=dev_box_name, until=until
    )
...
def devcenter_dev_box_show_action(
    cmd, project_name, dev_box_name, action_name, user_id="me", dev_center=None, endpoint=None
):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
    return cf_dataplane.dev_box.get_action(
        user_id=user_id, dev_box_name=dev_box_name, action_name=action_name
    )
...
def devcenter_environment_list(cmd, project_name, user_id="me", dev_center=None, endpoint=None):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
    if user_id is not None:
...
def devcenter_environment_delete(
    cmd, project_name, environment_name, no_wait=False, user_id="me", dev_center=None, endpoint=None
):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
    return sdk_no_wait(
        no_wait,
...
def devcenter_environment_type_list_dp(cmd, project_name, dev_center=None, endpoint=None):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
    return cf_dataplane.environment_type.list()


def devcenter_notification_setting_show_dp(cmd, project_name, user_id="me", dev_center=None, endpoint=None):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
    return cf_dataplane.notification_setting.get(user_id=user_id)


def devcenter_notification_setting_list_allowed_culture_dp(
    cmd, project_name, user_id="me", dev_center=None, endpoint=None
):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
...
def devcenter_environment_definition_list_dp(
    cmd, project_name, catalog_name=None, dev_center=None, endpoint=None
):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
    if catalog_name is not None:
    ...
    return cf_dataplane.environment_definitions.list_by_project()


def devcenter_environment_definition_show_dp(
    cmd, project_name, catalog_name, definition_name, dev_center=None, endpoint=None
):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
...
def devcenter_catalog_show_dp(cmd, project_name, catalog_name, dev_center=None, endpoint=None):
    cf_dataplane = cf_devcenter_dataplane(cmd.cli_ctx, endpoint, dev_center, project_name)
